...
/*   Updated: 2024/10/11 16:44:14 by kethouve         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*Constructor*/
ShrubberyCreationForm::ShrubberyCreationForm(): AForm::AForm("SCF", 145, 137), _target("null")
{}

ShrubberyCreationForm::ShrubberyCreationForm(const std::string &target): AForm::AForm("SCF", 145, 137), _target(target)
{}
